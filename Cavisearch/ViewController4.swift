...
//  Cavisearch
//
//  Created by Geovani Oneal on 11/25/19.
...
//This mimics the first ViewController as all the controllers do the same things but just handles the 3 different views

class ViewController4: UIViewController, AVCaptureVideoDataOutputSampleBufferDelegate{
